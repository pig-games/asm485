...
| **D-6** | DRY | Medium | Partial | Expanded shared MOS-family registry test helper usage across runtime execution-model budget/encode/tokenizer plus m65816 expr/package-load tests; additional boilerplate remains |
