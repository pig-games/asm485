...
| **D-6** | DRY | Medium | Partial | Expanded shared MOS-family registry test helper usage across runtime execution-model budget/encode/tokenizer tests; additional boilerplate remains |
