# VM C64 Native Harness Scaffold
...
```bash
cargo run -- -i examples/vm/c64/native6502_harness.asm -x build/vm-native6502-harness.hex
```

Outputs:

- `build/vm-native6502-harness.hex`
- `build/vm-native6502-harness.prg`
- `build/vm-native6502-harness.map`

## Run in VICE

```bash
x64sc -autostart build/vm-native6502-harness.prg
```
